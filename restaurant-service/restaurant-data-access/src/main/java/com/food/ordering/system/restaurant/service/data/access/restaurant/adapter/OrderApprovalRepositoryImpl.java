...
public class OrderApprovalRepositoryImpl implements OrderApprovalRepository {
    ...
    @Override
    public OrderApproval save(OrderApproval ordeerrApproval) {
        return restaurantDataAccessMapper.orderApprovalEntityToOrderApproval(
                orderApprovalJpaRepository.save((restaurantDataAccessMapper.orderApprovalToOrderApprovalEntity(ordeerrApproval)))
        );
    }
}
